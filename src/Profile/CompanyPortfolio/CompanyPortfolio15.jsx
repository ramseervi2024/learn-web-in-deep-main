...
export default function CompanyPortfolio15() {
          ...
          <div className="flex items-center gap-6">
            <div className="w-10 h-10 bg-[#1a1a1a] flex items-center justify-center group cursor-pointer overflow-hidden">
               <motion.div whileHover={{ y: -40 }} className="transition-transform duration-500">
                  <div className="h-10 w-10 flex items-center justify-center text-white font-black text-xl italic select-none">R</div>
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[8px] font-mono opacity-30 uppercase tracking-[0.2em] mt-1">{data?.brand?.business_type}</span>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex justify-between items-end border-t border-white/10 pt-12">
               <div className="flex flex-col gap-2">
                 ...
                 <span className="text-xl font-bold italic">{data?.brand?.email}</span>
               </div>
      ...
      <main>
        ...
        <section className="min-h-screen pt-40 pb-20 px-8 lg:px-32 flex flex-col justify-end relative overflow-hidden">
           ...
           <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-20 items-end">
              ...
              <div className="lg:col-span-4 hidden lg:flex flex-col gap-12 border-l border-[#1a1a1a]/5 pl-12">
           ...
           <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 border border-[#1a1a1a]/10">
                 {data?.services?.map((service, i) => (
                    <div key={i} className="p-12 border-r border-b border-[#1a1a1a]/10 hover:bg-[#1a1a1a] hover:text-white transition-all group relative overflow-hidden">
           ...
           <div className="flex overflow-x-auto no-scrollbar gap-12 px-8 lg:px-32 pb-12">
              {data?.completed_projects?.map((project, i) => (
                 <motion.div 
                    key={i} 
                    whileHover={{ y: -10 }}
                    className="min-w-[320px] md:min-w-[600px] flex flex-col group cursor-pointer"
                 >
                    ...
                    <div className="flex justify-between items-start">
                       <div className="flex flex-col gap-2">
                          ...
                          <p className="text-white/70 text-sm max-w-md font-light leading-relaxed">{project.problem}</p>
                       </div>
           ...
           <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-32">
              <div>
                 ...
                 <p className="text-xl text-[#1a1a1a]/60 font-light leading-relaxed mb-20 max-w-sm">
                   Ready to upgrade your infrastructure with precision-engineered solutions? Initialize the connection below.
                 </p>
                 ...
                 <div className="space-y-12">
                    <div className="flex flex-col group cursor-pointer border-b border-[#1a1a1a]/10 pb-4 hover:border-[#ff3e3e] transition-all">
                       ...
                       <span className="text-2xl md:text-4xl font-bold italic text-[#1a1a1a]">{data?.brand?.email}</span>
                    </div>
                    <div className="flex flex-col group cursor-pointer border-b border-[#1a1a1a]/10 pb-4 hover:border-[#ff3e3e] transition-all">
                       ...
                       <span className="text-2xl md:text-4xl font-bold italic text-[#1a1a1a]">{data?.brand?.location}</span>
                    </div>
                 </div>
              </div>
                 ...
                 <div className="aspect-square bg-[#1a1a1a] flex items-center justify-center p-20 relative overflow-hidden">
                    ...
                    <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-12 w-full z-10 flex flex-col gap-10">
                       ...
                       <p className="text-white/80 text-[10px] font-mono leading-relaxed uppercase tracking-widest">
                         Established on {data?.brand?.founded}.<br />
        ...
        <footer className="py-20 px-8 lg:px-32 bg-[#1a1a1a] text-white overflow-hidden relative">
           <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
              <div className="flex items-center gap-8">
                 ...
                 <span className="text-[9px] font-mono text-white/30 uppercase tracking-widest">{data?.footer?.tagline}</span>
              </div>
