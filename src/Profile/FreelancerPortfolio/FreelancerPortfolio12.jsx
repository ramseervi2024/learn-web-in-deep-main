...
export default function FreelancerPortfolio12() {
      ...
      <nav className={`fixed top-0 inset-x-0 z-[100] transition-all p-12 flex justify-between items-center ${scrolled ? 'translate-y-[-10px] opacity-0' : 'translate-y-0 opacity-100'}`}>
        <div className="flex items-center gap-6 group cursor-pointer text-left">
          <div className="w-12 h-12 rounded-full border-2 border-white/20 flex items-center justify-center group-hover:border-white transition-all overflow-hidden relative">
             ...
             <span className="text-sm font-black relative z-10 group-hover:text-black transition-colors uppercase italic tracking-tighter">RP</span>
          </div>
          ...
          <motion.div style={{ x: smoothX }} className="flex h-full w-[500vw] flex-nowrap shrink-0">
            ...
            <SectionWrap title="01 // CORE VISION">
              <div className="pt-20">
                ...
                <h1 className="text-[11vw] font-black leading-[0.8] tracking-tighter uppercase italic select-none">
                  Engineering<br/>Digital<br/><span className="text-transparent italic" style={{ WebkitTextStroke: "2px rgba(255,255,255,0.6)" }}>Elite.</span>
                </h1>
              </div>
              <div className="pb-12 flex justify-between items-end w-full">
                ...
                <div className="hidden lg:flex flex-col gap-2 border-l-2 border-white/10 pl-10 text-left">
                  <span className="text-[10px] font-black uppercase tracking-[0.4em] text-white/20 italic">Established Protocol</span>
                  <span className="text-4xl font-black italic tracking-tighter tabular-nums">MMXXIII</span>
                </div>
              </div>
            </SectionWrap>
            ...
            <SectionWrap title="02 // ARCHITECTURE" className="bg-[#080808]">
              <div className="pt-16">
                 <h2 className="text-[8vw] font-black uppercase italic tracking-tighter leading-[0.8] mb-8">System <span className="text-transparent" style={{ WebkitTextStroke: "1px rgba(255,255,255,0.6)" }}>Logic.</span></h2>
              </div>
            ...
            <SectionWrap title="03 // PROJECT ARCHIVE">
              <div className="pt-12">
                <h2 className="text-[6vw] font-black uppercase italic tracking-tighter leading-none mb-12">Select <span className="text-transparent" style={{ WebkitTextStroke: "1px rgba(255,255,255,0.4)" }}>Nodes.</span></h2>
              </div>
            ...
            <SectionWrap title="05 // TERMINATE">
               <div className="pt-12">
                  <h2 className="text-[12vw] font-black uppercase tracking-tighter italic leading-[0.8]">PROJECT<br/><span className="text-transparent" style={{ WebkitTextStroke: "2px rgba(255,255,255,0.6)" }}>COMPLETE.</span></h2>
               </div>
               <div className="pb-24 w-full flex flex-col md:flex-row justify-between items-end gap-20">
                  <div className="flex flex-col gap-10 text-left">
                     ...
                     <a href={`mailto:${data.brand.email}`} className="text-4xl lg:text-7xl font-black uppercase italic tracking-tighter hover:text-cyan-500 transition-all">{data.brand.email}</a>
                  </div>
