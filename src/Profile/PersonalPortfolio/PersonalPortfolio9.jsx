...
const FuturisticHero = () => {
  ...
  const fullText = "Initializing digital architect... System ready. Welcome to the future of mobile engineering.";
      ...
      >
        <div className="flex flex-col items-center text-center gap-6 mb-12">
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-cyan-500/30 bg-cyan-500/5 backdrop-blur-xl mb-8">
                ...
                <span className="text-xs font-bold uppercase tracking-[0.3em] text-cyan-400/80">Eng. Core Active</span>
            </div>
            ...
            <h1 className="text-5xl md:text-8xl lg:text-[7rem] font-black tracking-tighter leading-[0.9] text-white">
                {data.hero.title.split(' ').map((word, i) => (
                    <span key={i} className={`inline-block mr-4 italic last:not-italic ${word === 'Excellence.' ? 'text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600' : ''}`}>
                        {word}
                    </span>
                ))}
            </h1>
  ...
  >
    ...
    <div className="relative z-10">
      <div className="w-14 h-14 rounded-2xl bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center mb-8 text-cyan-400 group-hover:scale-110 transition-transform">
        {index % 6 === 0 && <Code2 size={28} />}
        {index % 6 === 1 && <Smartphone size={28} />}
        {index % 6 === 2 && <Terminal size={28} />}
        {index % 6 === 3 && <Layers size={28} />}
        {index % 6 === 4 && <Zap size={28} />}
        {index % 6 === 5 && <Shield size={28} />}
      </div>
      ...
      <p className="text-slate-400 font-light leading-relaxed mb-8">
        {service.description || "Specializing in premium application development and deployment."}
      </p>
            ...
            >
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-400 to-blue-600 flex items-center justify-center p-0.5 shadow-[0_0_20px_rgba(34,211,238,0.3)]">
                    <div className="w-full h-full bg-[#020617] rounded-[10px] flex items-center justify-center">
                        <span className="text-xl font-black bg-clip-text text-transparent bg-gradient-to-br from-cyan-400 to-blue-600">
                            {data.personal_info.name.split(' ').map(n => n[0]).join('')}
                        </span>
                    </div>
                </div>
                <span className="text-xl font-bold tracking-tighter text-white">Engineering Hub</span>
            </motion.div>
      ...
      <main className="relative z-10 flex flex-col items-center">
        ...
        <section id="architecture" className="w-full py-24 md:py-48 px-6 max-w-7xl">
            <SectionHeader 
                ...
                subtitle="Engineering scalable mobile ecosystems that evolve with technological advancements and business needs."
            />
        ...
        <section id="pricing" className="w-full py-24 md:py-48 px-6 max-w-7xl bg-[#020617] border-t border-white/5">
            <SectionHeader 
                ...
                subtitle="Flexible investment models engineered to match project velocity and development goals."
            />
        ...
        <section id="connect" className="w-full py-24 md:py-48 px-6 relative overflow-hidden bg-[#020617] border-t border-white/5">
            ...
            <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center text-center">
                ...
                <p className="text-xl md:text-2xl text-slate-400 mb-16 max-w-2xl font-light">
                    Available for high-impact mobile development projects. Let's build something exceptional.
                </p>
                
                <a href={`mailto:${data.personal_info.email}`} className="group relative h-20 md:h-24 px-12 md:px-20 bg-white text-black flex items-center justify-center gap-4 rounded-full font-black uppercase tracking-widest text-lg md:text-2xl shadow-[0_0_50px_rgba(255,255,255,0.2)] hover:scale-105 active:scale-95 transition-all">
                    <Mail size={32} />
                    Initialize Project
            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
                <div>
                    <div className="text-2xl font-black text-white mb-2 italic tracking-tighter">
                        {data.personal_info.name}<span className="text-cyan-500">.</span>
                    </div>
                ...
                <div className="flex flex-col items-center md:items-end gap-2 text-slate-500 text-[10px] font-bold uppercase tracking-widest">
                    <div>© {new Date().getFullYear()} {data.personal_info.name}. All rights reserved.</div>
