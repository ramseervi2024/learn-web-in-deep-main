...
const FuturisticHero = () => {
  ...
  const fullText = "Initializing digital architect... System ready. Welcome to your professional identity core.";
      ...
      >
        <div className="flex flex-col items-center text-center gap-6 mb-12">
          ...
          <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-cyan-500/30 bg-cyan-500/5 backdrop-blur-xl mb-8">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.3em] text-cyan-400/80">Personal Core Active</span>
          </div>
  ...
  >
    ...
    <div className="lg:col-span-5 px-4 md:px-0">
      ...
      <button className="flex items-center gap-3 text-white font-bold group">
        Explore Case Study <ArrowRight size={20} className="group-hover:translate-x-2 transition-transform" />
      </button>
    </div>
  </motion.div>
);
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-400 to-blue-600 flex items-center justify-center p-0.5 shadow-[0_0_20px_rgba(34,211,238,0.3)]">
              <div className="w-full h-full bg-[#020617] rounded-[10px] flex items-center justify-center">
                <span className="text-xl font-black bg-clip-text text-transparent bg-gradient-to-br from-cyan-400 to-blue-600">{data.brand.name.charAt(0)}</span>
              </div>
            </div>
            <span className="text-xl font-bold tracking-tighter text-white">{data.brand.name}</span>
          </motion.div>
      ...
      <main className="relative z-10 flex flex-col items-center">
        ...
        <section id="architecture" className="w-full py-24 md:py-48 px-6 max-w-7xl">
          <SectionHeader 
            ...
            subtitle="Engineered for scalability and high-impact digital presence. We build the architecture that sustains your professional growth."
          />
        ...
        <section id="pricing" className="w-full py-24 md:py-48 px-6 max-w-7xl bg-[#020617] border-t border-white/5">
          <SectionHeader 
            ...
            subtitle="Transparent investment models designed for high-end project delivery and long-term professional partnerships."
          />
        ...
        <section className="w-full py-24 md:py-48 px-6 max-w-5xl border-t border-white/5">
           <SectionHeader 
            ...
            subtitle="Core operational queries and procedural information. Complete transparency on all development workflows."
          />
        ...
        <section id="connect" className="w-full py-24 md:py-48 px-6 relative overflow-hidden bg-[#020617] border-t border-white/5">
          ...
          <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center text-center">
            ...
            <p className="text-xl md:text-2xl text-slate-400 mb-16 max-w-2xl font-light">
              Secure a development slot today. We are currently accepting high-impact projects for the upcoming quarters.
            </p>
            
            <a href={`mailto:${data.contact.email}`} className="group relative h-20 md:h-24 px-12 md:px-20 bg-white text-black flex items-center justify-center gap-4 rounded-full font-black uppercase tracking-widest text-lg md:text-2xl shadow-[0_0_50px_rgba(255,255,255,0.2)] hover:scale-105 active:scale-95 transition-all">
              <Mail size={32} />
              Initialize Project
        ...
        <footer className="w-full py-12 px-6 border-t border-white/5 bg-[#01030d] text-center md:text-left">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
            ...
            <div className="flex flex-col items-center md:items-end gap-2 text-slate-500 text-[10px] font-bold uppercase tracking-widest">
              ...
              <div className="text-cyan-400/40">Status: Stable Build 2.1.0</div>
            </div>
          </div>
        </footer>
      </main>
