            ...
            <div className="flex gap-8 animate-[marquee_50s_linear_infinite] px-4 hover:[animation-play-state:paused] cursor-default whitespace-nowrap">
              {[...data.testimonials, ...data.testimonials, ...data.testimonials, ...data.testimonials].map((test, i) => (
                ...
                >
                  ...
                  <div className="items-center gap-4 mt-auto hidden">
        ...
        <section id="contact" className="py-32 px-6 border-t border-white/5 bg-gradient-to-b from-[#030712] to-slate-950">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20">
             ...
             <div>
               ...
               <p className="text-xl text-slate-400 font-light mb-12">Share your project details, and I will get back to you within 24 hours.</p>
